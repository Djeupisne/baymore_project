...
extension ReturnStatusX on ReturnStatus {
  ...
  String get asString {
    switch (this) {
      case ReturnStatus.approuve: return 'APPROUVE';
      case ReturnStatus.refuse: return 'REFUSE';
      case ReturnStatus.rembourse: return 'REMBOURSE';
      case ReturnStatus.enAttente: return 'EN_ATTENTE';
    }
  }
  String get label {
    switch (this) {
      case ReturnStatus.enAttente: return 'En attente';
      case ReturnStatus.approuve: return 'Approuvé';
      case ReturnStatus.refuse: return 'Refusé';
