...
class AppStrings {
  ...
  static const Map<String, String> _fr = {
    ...
    'promotionNotification': 'Promotion spéciale',
    'promoDisabledNotification': 'Code promo désactivé',
    'newProductNotification': 'Nouveau produit disponible',
    'restockNotification': 'Article de nouveau en stock',
    'newOrderNotification': 'Nouvelle commande',
    'messageNotification': 'Nouveau message',
    'orderStatusNotification': 'Statut de commande mis à jour',
    'catalogNotification': 'Nouveau catalogue disponible',
  ...
  static const Map<String, String> _en = {
    ...
    'promotionNotification': 'Special promotion',
    'promoDisabledNotification': 'Promo code disabled',
    'newProductNotification': 'New product available',
    'restockNotification': 'Item back in stock',
    'newOrderNotification': 'New order',
    'messageNotification': 'New message',
    'orderStatusNotification': 'Order status updated',
    'catalogNotification': 'New catalog available',
